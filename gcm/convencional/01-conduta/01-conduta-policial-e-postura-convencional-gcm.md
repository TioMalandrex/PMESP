# 01 — Conduta Policial e Postura (Convencional)

## 1. Princípios de conduta
A guarnição convencional atua com postura preventiva, firmeza proporcional e foco em mediação inicial de conflitos.

## 2. Regras de apresentação
- uniforme e identificação visível;
- equipamentos conferidos no início do turno;
- postura profissional em todo atendimento.

## 3. Conduta em serviço
- abordagem respeitosa e técnica;
- prioridade para orientação e prevenção;
